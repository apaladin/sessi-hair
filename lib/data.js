...
export const COLLECTIONS = [
  {
    ...
    models: [u('1509967419530-da38b4704bc6'), u('1544005313-94ddf0286df2')],
    products: [
  ...
  },
  {
    ...
    models: [u('1531746020798-e6953c6e8e04'), u('1494790108377-be9c29b29330')],
    products: [
  ...
  },
  {
    ...
    models: [u('1529626455594-4ff0802cfb7e'), u('1485875437342-9b39470b3d95')],
    products: [
  ...
  },
  {
    ...
    models: [u('1519699047748-de8e457a634e'), u('1526510747491-58f928ec870f')],
    products: [
  ...
  },
  {
    ...
    models: [u('1524250502761-1ac6f2e30d43'), u('1524504388940-b1c1722653e1')],
    products: [
...
export const STOPS = [
  { pos: [0, 1.7, 8.4], look: [0, 2.0, -2], title: 'Welcome', sub: 'Look around — every collection has its own room within the room.' },
  { pos: [0, 1.65, 5.2], look: [0, 2.3, 2.2], title: 'The Crown', sub: 'Our signature installation — every shade of the house, falling from one gold ring.' },
  { pos: [2.9, 1.65, 6.1], look: [6.4, 1.8, 4.5], title: 'The Mirror', sub: 'Step closer — tap the mirror to see yourself in Sessi hair.', mirror: true },
